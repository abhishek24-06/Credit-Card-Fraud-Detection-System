    ...
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      >
        ...
        <button
          ...
          disabled={refreshing}
          className="flex items-center gap-2 px-4 py-2 rounded-lg bg-navy-800 border border-navy-700 text-slate-300 text-sm font-medium hover:bg-navy-700 transition-all disabled:opacity-50"
      ...
      {stats && (
        ...
        >
          <div className="glass-card p-4 text-center">
            ...
            <p className="text-xl font-bold text-blue-400">{stats.total_analyzed}</p>
          </div>
          <div className="glass-card p-4 text-center">
      ...
      >
        {loading ? (
          ...
          <div className="text-center py-16 space-y-3">
            <div className="w-16 h-16 mx-auto rounded-2xl bg-navy-800 flex items-center justify-center">
